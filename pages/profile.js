        ...
        <div className="relative rounded-md overflow-hidden">
          ...
          <div className="p-4 pb-0">
            ...
            <div className="mt-10 flex gap-0 ">
              <Link
                href=""
                className="flex gap-1 px-4 py-1 items-center border-b-4 border-b-blue-500 text-socialBlue font-bold"
              >
                <svg
              ...
              <Link
                href=""
                className="flex gap-1 px-4 py-1 border-b-4 border-b-white items-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
