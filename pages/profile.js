...
function ProfilePage() {
  const tabClasses =
    "flex gap-1 md:px-4 py-1 border-b-4 border-b-white items-center";
  const activeTapClasses =
    "flex gap-1 md:px-4 py-1 items-center border-b-4 border-b-blue-500 text-socialBlue font-bold";
        ...
        <div className="relative rounded-md overflow-hidden">
          ...
          <div className="p-4 pt-0 md:pt-4 pb-0">
            <div className="ml-24 md:ml-40">
              <h1 className="text-xl mx-1 md:text-3xl font-bold">
                Ahmed Shabaan
              </h1>
              <p className="text-gray-500 leading-4 mx-1">Cairo, Egypt</p>
            </div>
            <div className="mt-8 md:mt-10 flex gap-16 md:gap-0 items-center ">
              <Link
                href={"/profile/posts"}
              ...
              >
                ...
                <span className="sm:block hidden">Posts</span>
              </Link>
              <Link
                href={"/profile/about"}
              ...
              >
                ...
                <span className="sm:block hidden">About</span>
              </Link>
              <Link
              ...
              >
                ...
                <span className="sm:block hidden">Friends</span>
              </Link>
              <Link
                href={"/profile/photos"}
              ...
              >
                ...
                <span className="sm:block hidden">Photos</span>
              </Link>
            </div>
          </div>
        </div>
